...
int main()
{
    ...
    *ImagemCam1OK = 0;
    ...
    int ImgWidth = 632; //Max 1448
    int regiaoScan = 2;
    int ImgHeight = 4; //Max 1086 //100 obs. deve resultar em um número par
    int OffsetX = 330;
    int OffsetY = 1086-650; //obs. o valor é reduzido de 1086 por que a câmera está invertida verticalmente
    ...
    // Salva imagem
	std::string name = "GV4_cam1.png"; //Define endereço das imagens
	imwrite(name, image1F);

	cv::Mat resized;
	resize(image1F, resized, Size(ImgWidth/2, 780/2), 0, 0, INTER_CUBIC);
	name = "GV4_cam1_resized.png";
