...
int main()
{
    ...
    *ImagemCam2OK = 0;
    ...
    // Salva imagem
	std::string name = "GV3_cam2.png"; //Define endereço das imagens
	imwrite(name, image1F);

	cv::Mat resized;
	resize(image1F, resized, Size(ImgWidth/2, 960/2), 0, 0, INTER_CUBIC);
	name = "GV3_cam2_resized.png";
