...
int main()
{
    ...
    *ImagemCam1OK = 0;
    ...
    // Salva imagem
	std::string name = "GV7_cam1.png"; //Define endereço das imagens
	imwrite(name, image1F);

	cv::Mat resized;
	resize(image1F, resized, Size(ImgWidth/2, 480/2), 0, 0, INTER_CUBIC);
	name = "GV7_cam1_resized.png";
