...
int main()
{
    ...
    *ImagemCam1OK = 0;
    ...
    int ImgWidth = 440; //Max 1448
    int regiaoScan = 2;
    int ImgHeight = 4; //Max 1086 //100 obs. deve resultar em um número par
    int OffsetX = 560;
    int OffsetY = 1086-730; //obs. o valor é reduzido de 1086 por que a câmera está invertida verticalmente
    ...
    templMatching = imread("RedesGV2/2.png", CV_32FC1);
