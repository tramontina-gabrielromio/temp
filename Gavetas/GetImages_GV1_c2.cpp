...
int main()
{
    ...
    *ImagemCam2OK = 0;
    ...
    templMatching = imread("RedesGV1/3.png", CV_32FC1);
	...
	imgMatching = resized(cv::Rect(x, y, width, height)).clone();
    templMatching = imread("RedesGV1/4.png", CV_32FC1);
	...
	imgMatching = resized(cv::Rect(x, y, width, height)).clone();
    templMatching = imread("RedesGV1/5.png", CV_32FC1);
	...
	imgMatching = resized(cv::Rect(x, y, width, height)).clone();
    templMatching = imread("RedesGV1/9.png", CV_32FC1);
	...
	imgMatching = resized(cv::Rect(x, y, width, height)).clone();
    templMatching = imread("RedesGV1/10.png", CV_32FC1);
	...
	imgMatching = resized(cv::Rect(x, y, width, height)).clone();
    templMatching = imread("RedesGV1/11.png", CV_32FC1);
