...
int main()
{
	...
	*contEncoder = 0;
	...
	cv::Mat frame, frame1, frame2, concat;
	std::string name;
	int cont1=0;
	int cont2=0;
	int cont3=0;
	...
	while(1){
		...
		if ((RedeTool1() + RedePont1())==2){
			...
			/*frame = cv::imread("Pont1.png");
			name = "Retreino/1/Errado/" + std::to_string(cont1) + ".png";
			imwrite(name, frame);
			cont1++;*/
		}
		else{
			...
			/*frame = cv::imread("Pont1.png");
			name = "Retreino/1/Correto/" + std::to_string(cont1) + ".png";
			imwrite(name, frame);
			cont1++;*/
		}
		...
		if ((RedeTool2() + RedePont2())==2){
			...
			/*frame = cv::imread("Pont2.png");
			name = "Retreino/2/Errado/" + std::to_string(cont2) + ".png";
			imwrite(name, frame);
			cont2++;*/
		}
		else{
			...
			/*frame = cv::imread("Pont2.png");
			name = "Retreino/2/Correto/" + std::to_string(cont2) + ".png";
			imwrite(name, frame);
			cont2++;*/
		}
		...
		if ((RedeTool3() + RedePont3())==2){
			...
			/*frame = cv::imread("Pont3.png");
			name = "Retreino/3/Errado/" + std::to_string(cont3) + ".png";
			imwrite(name, frame);
			cont3++;*/
		}
		else{
			...
			/*frame = cv::imread("Pont3.png");
			name = "Retreino/3/Correto/" + std::to_string(cont3) + ".png";
			imwrite(name, frame);
			cont3++;*/
		}
		...
		if ((RedeTool4() + RedePont4())==2){
			...
			/*frame = cv::imread("Pont4.png");
			name = "Retreino/4/Errado/" + std::to_string(cont4) + ".png";
			imwrite(name, frame);
			cont4++;*/
		}
		else{
			...
			/*frame = cv::imread("Pont4.png");
			name = "Retreino/4/Correto/" + std::to_string(cont4) + ".png";
			imwrite(name, frame);
			cont4++;*/
		}
		...
		if ((RedeTool5() + RedePont5())==2){
			...
			/*frame = cv::imread("Pont5.png");
			name = "Retreino/5/Errado/" + std::to_string(cont5) + ".png";
			imwrite(name, frame);
			cont5++;*/
		}
		else{
			...
			/*frame = cv::imread("Pont5.png");
			name = "Retreino/5/Correto/" + std::to_string(cont5) + ".png";
			imwrite(name, frame);
			cont5++;*/
		}
		...
		if ((RedeTool6() + RedePont6())==2){
			...
			//cv::putText(imageFV2, "Correto", cv::Point(1140, 156), FONT_HERSHEY_SIMPLEX, 1.5, cv::Scalar(0, 255, 0, 0), 4, LINE_8, false);
			/*frame = cv::imread("Pont6.png");
			name = "Retreino/6/Errado/" + std::to_string(cont6) + ".png";
			imwrite(name, frame);
			cont6++;*/
		}
		else{
			...
			//cv::putText(imageFV2, "Errado", cv::Point(1140, 156), FONT_HERSHEY_SIMPLEX, 1.5, cv::Scalar(0, 0, 255, 0), 4, LINE_8, false);
			/*frame = cv::imread("Pont6.png");
			name = "Retreino/6/Correto/" + std::to_string(cont6) + ".png";
			imwrite(name, frame);
			cont6++;*/
		}
		...
		if ((RedeTool7() + RedePont7())==2){
			...
			//cv::putText(imageFV2, "Correto", cv::Point(1140, 156), FONT_HERSHEY_SIMPLEX, 1.5, cv::Scalar(0, 255, 0, 0), 4, LINE_8, false);
			/*frame = cv::imread("Pont7.png");
			name = "Retreino/7/Errado/" + std::to_string(cont7) + ".png";
			imwrite(name, frame);
			cont7++;*/
		}
		else{
			...
			//cv::putText(imageFV2, "Errado", cv::Point(1140, 156), FONT_HERSHEY_SIMPLEX, 1.5, cv::Scalar(0, 0, 255, 0), 4, LINE_8, false);
			/*frame = cv::imread("Pont7.png");
			name = "Retreino/7/Correto/" + std::to_string(cont7) + ".png";
			imwrite(name, frame);
			cont7++;*/
		}
		...
		if ((RedeTool8() + RedePont8())==2){
			...
			//cv::putText(imageFV2, "Correto", cv::Point(1140, 156), FONT_HERSHEY_SIMPLEX, 1.5, cv::Scalar(0, 255, 0, 0), 4, LINE_8, false);
			/*frame = cv::imread("Pont8.png");
			name = "Retreino/8/Errado/" + std::to_string(cont8) + ".png";
			imwrite(name, frame);
			cont8++;*/
		}
		else{
			...
			//cv::putText(imageFV2, "Errado", cv::Point(1140, 156), FONT_HERSHEY_SIMPLEX, 1.5, cv::Scalar(0, 0, 255, 0), 4, LINE_8, false);
			/*frame = cv::imread("Pont8.png");
			name = "Retreino/8/Correto/" + std::to_string(cont8) + ".png";
			imwrite(name, frame);
			cont8++;*/
		}
		...
		if ((RedeTool9() + RedePont9())==2){
			...
			name = "Retreino/9/Errado/" + std::to_string(cont9) + ".png";
			imwrite(name, frame);
			cont9++;*/
		}
		else{
			...
			//cv::putText(imageFV2, "Errado", cv::Point(1140, 156), FONT_HERSHEY_SIMPLEX, 1.5, cv::Scalar(0, 0, 255, 0), 4, LINE_8, false);
			/*frame = cv::imread("Pont9.png");
			name = "Retreino/9/Correto/" + std::to_string(cont9) + ".png";
			imwrite(name, frame);
			cont9++;*/
		}
		...
		if ((RedeTool10() + RedePont10())==2){
			...
			name = "Retreino/10/Errado/" + std::to_string(cont10) + ".png";
			imwrite(name, frame);
			cont10++;*/
		}
		else{
			...
			//cv::putText(imageFV2, "Errado", cv::Point(1140, 156), FONT_HERSHEY_SIMPLEX, 1.5, cv::Scalar(0, 0, 255, 0), 4, LINE_8, false);
			/*frame = cv::imread("Pont10.png");
			name = "Retreino/10/Correto/" + std::to_string(cont10) + ".png";
			imwrite(name, frame);
			cont10++;*/
		}
		...
		if ((RedeTool11() + RedePont11())==2){
			...
			name = "Retreino/11/Errado/" + std::to_string(cont11) + ".png";
			imwrite(name, frame);
			cont11++;*/
		}
		else{
			...
			//cv::putText(imageFV2, "Errado", cv::Point(1140, 156), FONT_HERSHEY_SIMPLEX, 1.5, cv::Scalar(0, 0, 255, 0), 4, LINE_8, false);
			/*frame = cv::imread("Pont11.png");
			name = "Retreino/11/Correto/" + std::to_string(cont11) + ".png";
			imwrite(name, frame);
			cont11++;*/
		}
		...
		if ((RedeTool12() + RedePont12())==2){
			...
			name = "Retreino/12/Errado/" + std::to_string(cont12) + ".png";
			imwrite(name, frame);
			cont12++;*/
		}
		else{
			...
			//cv::putText(imageFV2, "Errado", cv::Point(1140, 156), FONT_HERSHEY_SIMPLEX, 1.5, cv::Scalar(0, 0, 255, 0), 4, LINE_8, false);
			/*frame = cv::imread("Pont12.png");
			name = "Retreino/12/Correto/" + std::to_string(cont12) + ".png";
			imwrite(name, frame);
			cont12++;*/
		}
		...
		if ((RedeTool13() + RedePont13())==2){
			...
			name = "Retreino/13/Errado/" + std::to_string(cont13) + ".png";
			imwrite(name, frame);
			cont13++;*/
		}
		else{
			...
			/*frame = cv::imread("Pont13.png");
			name = "Retreino/13/Correto/" + std::to_string(cont13) + ".png";
			imwrite(name, frame);
			cont13++;*/
		}
